# Copyright Arxan Fintech 2016 All Rights Reserved.
#
...
from ..constants import DEFAULT_MEMBERSRVC_GRPC_ADDR
#from ..util.log import debug


class MemberServices(object):
    """Default implementation of a member services client
    """
    ...
    def __init__(self, name, grpc_addr=DEFAULT_MEMBERSRVC_GRPC_ADDR):
        ...
        self.ecaa_stub = ca_pb2.ECAAStub(self.channel)
        self.ecap_stub = ca_pb2.ECAPStub(self.channel)
        self.tcap_stub = ca_pb2.TCAPStub(self.channel)
        self.tlscap_stub = ca_pb2.TLSCAPStub(self.channel)
