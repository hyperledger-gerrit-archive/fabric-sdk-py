...
from hfc.protos.peer import proposal_pb2, transaction_pb2
...
def send_transaction(orderers, tran_req, tx_context, scheduler=None):
    ...
    envelope = sign_tran_payload(tx_context, tran_payload)
...
def sign_tran_payload(tx_context, tran_payload):
