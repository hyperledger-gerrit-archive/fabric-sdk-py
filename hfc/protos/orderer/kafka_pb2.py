...
_KAFKAMETADATA = _descriptor.Descriptor(
  name='KafkaMetadata',
  full_name='hfc.protos.orderer.KafkaMetadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='last_offset_persisted', full_name='hfc.protos.orderer.KafkaMetadata.last_offset_persisted', index=0,
...
KafkaMetadata = _reflection.GeneratedProtocolMessageType('KafkaMetadata', (_message.Message,), dict(
  ...
  __module__ = 'hfc.protos.orderer.kafka_pb2'
  # @@protoc_insertion_point(class_scope:hfc.protos.orderer.KafkaMetadata)
  ))
