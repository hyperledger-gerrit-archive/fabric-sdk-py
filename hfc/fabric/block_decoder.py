...
def decode_crypto_config(crypto_config_bytes):
    ...
    Args:
        crypto_config_bytes (str): Byte information containing FabricCyptoConfig
    ...
    if crypto_config_bytes:
        ...
        crypto_config['signature_hash_family'] = proto_crypto_config.signature_hash_family
        crypto_config['identity_identifier_hash_function'] = proto_crypto_config.identity_identifier_hash_function
...
def decode_fabric_peers_info(peers_info_bytes):
    ...
    for peer_info_bytes in peers_info_bytes:
        ...
        if peer_state_info.state_info.properties:
            ...
            if hasattr(peer_state_info.state_info.properties, 'chaincodes'):
                ...
                if peer_state_info.state_info.properties.chaincodes:
                    for chaincode in peer_state_info.state_info.properties.chaincodes:
                        cc = {}
        ...
        peer_membership_info.ParseFromString(peer_info_bytes.membership_info.payload)
