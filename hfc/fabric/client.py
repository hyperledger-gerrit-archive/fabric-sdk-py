...
class Client(object):
    ...
    def channel_create(self, orderer_name, channel_name, requester, config_yaml,channel_profile):
        """
        ...
        tx = self.generate_channel_tx(channel_name,config_yaml, channel_profile)
        if tx is None:
            return False
