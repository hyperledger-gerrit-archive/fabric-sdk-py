    ...
    async def chaincode_invoke(self, requestor, channel_name, peers, args,
        ...
        if wait_for_event:
            ...
            if cc_pattern is not None:
                # TODO we need to wait a moment for not
                # getting the precedent block in channel eventhub loop
                # This should be handle correctly, what should we wait?
                # Is this Batch Timeout parameter?
                time.sleep(2.1)
