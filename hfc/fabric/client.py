...
class Client(object):
    ...
    def channel_create(self, target_orderer, channel_name, requestor,
        ...
        :param target_orderer: Name or Orderer instance of orderer to get
        genesis block from
        ...
        if not orderer:
            _logger.error("No target_orderer instance found with name {}".
                          format(target_orderer))
            return False
    ...
    def channel_join(self, requestor, channel_name, target_peers,
                     target_orderer):
        """
        Join a channel.
        ...
        for target_peer in target_peers:
            if isinstance(target_peer, Peer):
                ...
                _logger.error('%s should be a peer name or a \
                Peer instance' % target_peer)
