...
class Client(object):
    ...
    def chaincode_instantiate(self, requestor, channel_name, peer_names, args, cc_name, cc_version):
        """
    ...
    def chaincode_invoke(self, requestor, channel_name, peer_names, args, cc_name, cc_version):
        """
