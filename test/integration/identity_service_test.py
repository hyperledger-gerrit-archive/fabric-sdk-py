...
class IdentityServiceTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._enrollment = self._ca_service.enroll(self._enrollment_id,
                                                   self._enrollment_secret)
        self._identitiService = self._ca_service.newIdentityService()
    ...
    def test_create_success(self):
        ...
        secret = self._identitiService.create(self._enrollment, username)
    ...
    def test_getOne_success(self):
        ...
        """
        username = get_random_username()
        self._identitiService.create(username)

        res = self._identitiService.getOne(username, self._enrollment)
    ...
    def test_getAll_success(self):
        ...
        res = self._identitiService.getAll(self._enrollment)
        self.assertTrue(res['result']['identities'] > 0)
        self.assertTrue(res['success'] is True)
    ...
    def test_delete_success(self):
        ...
        res = self._identitiService.delete(username, self._enrollment)
    ...
    def test_update_success(self):
        ...
        res = self._identitiService.update(username, self._enrollment,
                                           maxEnrollments=3)
