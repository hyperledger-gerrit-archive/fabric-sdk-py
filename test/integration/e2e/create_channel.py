...
from hfc.fabric.msp import msp
...
"""
test data for build the channel
"""
test_input = {}

pwd = os.path.dir_name(__file__)
crypto_msp = "../../fixtures/e2e_cli/channel/crypto-config/"
orderer_msp = crypto_dir + \
              "ordererOrgnizations/example.com/orderers/oderer.example.com/msp/"
order_pem = "ordererOrgnizations/example.com/ca/ca.example.com-cert.pem"
peer_msp = "peerOrgnizations/org0.example.com/peers/"
peer0 = crypto_msp + "peer0.org1.exmaple.com/msp/"
peer1 = crypto_msp + "peer1.org1.exmaple.com/msp/"
...
class CreateChannelTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.compose_file_path = os.path.normpath(
            os.path.join(pwd, "../fixtures/docker-compose-base.yaml"))

        self.caroot_path = os.path.join(pwd, crypto_dir + order_pem  )
    ...
    def test_create_channel(self):
        ...
        orderer = Orderer(pem, endmpoint = "orderer.example.com",
                          opts={"hostname" : "order.example.com"})

        msps.append(msp(util.load_msp('OrdererMSP', orderer_msp)))
        msps.append(msp(util.load_msp('Org0MSP', peer_dir + peer0)))
        msps.append(msp(util.load_msp('Org1MSP', peer_dir + peer1)))
