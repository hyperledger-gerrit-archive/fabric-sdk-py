...
class DiscoveryTest(BaseTestCase):
    ...
    def test_discovery(self):
        ...
        self.assertEqual(str(responses),
                         '''
[chaincodes {
name: "example_cc"
version: "1.0"
...
vscc: "vscc"
        ...
        # as we still cannot know if chaincode has been instantiated on all peers for now
        # https://github.com/hyperledger/fabric/blob/release-1.4/peer/chaincode/common.go#L315
