...
class E2eTest(BaseTestCase):
    ...
    async def get_filtered_block_events(self):
        ...
        channel_event_hub.registerBlockEvent(unregister=False, onEvent=self.onFilteredEvent)
    ...
    async def get_full_block_events(self):
        ...
        self.blocks = []
        channel_event_hub.registerBlockEvent(unregister=False, onEvent=self.onFullEvent)
        await stream
