...
class BlockDecoderTest(unittest.TestCase):
    ...
    def test_decode_block_data(self):
        ...
        self.assertListEqual(list(data_item.keys()), data_keys)
        self.assertListEqual(list(data_payload_header.keys()),
                             payload_header_keys)
        self.assertListEqual(list(sh.keys()), sh_keys)
        self.assertListEqual(list(ch.keys()), ch_keys)
        self.assertListEqual(list(sh['creator'].keys()),
                             sh_creator_keys)
