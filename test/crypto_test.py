...
from hfs.api.crypto.crypto import CURVE_P_256_Size, SHA3, SHA2, CURVE_P_384_Size, ecies
...
class CryptoTest(unittest.TestCase):
    ...
    def testEciesSECP384R1_SHA3(self):
        ...
        cipher_text = ecies384.encrypt(private_key.public_key(), self.plain_text)

        self.assertEqual(ecies384.decrypt(private_key, cipher_text), self.plain_text)
    ...
    def testEciesSECP256R1_SHA3(self):
        ...
        cipher_text = ecies256.encrypt(private_key.public_key(), self.plain_text)

        self.assertEqual(ecies256.decrypt(private_key, cipher_text), self.plain_text)
